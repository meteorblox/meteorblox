...
type ExploreActivity = {
  ...
  motherlodes: Array<{ round: number; winningTile: number; addedDslvr: number; balanceDslvr: number; payoutDslvr: number; hit: boolean; transaction: string | null; timestamp: string | null }>;

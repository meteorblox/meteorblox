  ...
  return (
    <main className="app-shell">
      <header className="topbar">
        ...
        <div className="top-actions">
          ...
          <div className="asset-tickers" aria-label="Token prices">
            <span className="price-chip mtbx-chip" title="DSLVR preview"><img className="ticker-slvr-core" src="/brand/dslvr-coin.png" alt="" aria-hidden="true" /><strong>$0.00</strong></span>
      ...
      <section className="round-strip" aria-label="Current round">
        ...
        <div><small>SLVR STRIKE</small><strong className="meteor-shower-total"><img className="round-slvr-core" src="/brand/dslvr-coin.png" alt="" aria-hidden="true" />{mtbxRoundReward.toFixed(2)}</strong></div>
      </section>
      ...
      {view === "mine" ? <div className="workspace">
        ...
        {currentAccount?.address.toLowerCase() === testnetOwner && !chainState?.rewardsBound && <article className="claim-card testnet-publish"><small>OWNER TESTNET MILESTONE</small><h2>Activate the live game</h2><p>One-time setup binds the unique DSLVR RewardCap to the shared Game and opens the first playable 60-second Testnet round.</p><button className="deploy" disabled={activatingGame} onClick={activateTestnetGame}>{activatingGame ? "Waiting for Slush approval…" : "Activate live Testnet round"}</button></article>}
      ...
      <footer><p><strong>SLVRBLOX / $DSLVR</strong> &middot; Rebrand preview &middot; Testnet contract still uses DSLVR</p><nav aria-label="Footer"><a href="#how">How it works</a><a href="#token">Token</a><a href="#faq">FAQ</a></nav></footer>

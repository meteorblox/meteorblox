      ...
      <header className="topbar">
        ...
        <div className="top-actions">
          ...
          <div className="asset-tickers" aria-label="Token prices">
            <span className="price-chip mtbx-chip" title="DSLVR preview"><img className="ticker-slvr-core" src="/brand/dslvr-coin.png" alt="" aria-hidden="true" /><strong><small>DSLVR</small>$0.00</strong></span>

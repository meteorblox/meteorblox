  ...
  return (
    <main className="app-shell">
      <header className="topbar">
        ...
        <nav className="main-nav" aria-label="Main navigation"><Link className={view === "mine" ? "active" : ""} href="/mine" onClick={() => { setView("mine"); setNotice(""); }}>Mine</Link><button className={view === "rewards" ? "active" : ""} onClick={() => setView("rewards")}>Rewards</button><Link className={view === "stake" ? "active" : ""} href="/stake">Stake</Link><Link href="/explore">Explore</Link><Link href="/airdrop">Airdrop</Link></nav>

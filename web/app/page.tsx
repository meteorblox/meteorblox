  ...
  return (
    <main className="app-shell">
      <header className="topbar">
        ...
        <nav className="main-nav" aria-label="Main navigation"><Link className={view === "mine" ? "active" : ""} style={view === "mine" ? { borderColor: "#6fbcf0" } : undefined} href="/mine" onClick={() => { setView("mine"); setNotice(""); }}>Mine</Link><button className={view === "rewards" ? "active" : ""} onClick={() => setView("rewards")}>Rewards</button><Link className={view === "stake" ? "active" : ""} style={view === "stake" ? { borderColor: "#6fbcf0" } : undefined} href="/stake">Stake</Link><Link href="/explore">Explore</Link><Link href="/airdrop">Airdrop</Link></nav>

...
export default function ReadinessPage() {
  ...
  return <main className="readiness-page">
    <header className="status-topbar"><Link href="/" className="status-brand"><img src="/brand/slvrblox-logo-trimmed.png" alt="SLVRBLOX" /></Link><nav><Link href="/mine">Mine</Link><Link href="/explore">Explore</Link><Link href="/status">Status</Link><Link className="active" href="/readiness">Readiness</Link></nav><span><i /> Owner operations</span></header>

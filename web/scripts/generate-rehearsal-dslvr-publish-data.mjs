...
const packageRoot = resolve(siteRoot, "../../slvrblox-mainnet-token");
...
writeFileSync(
  resolve(siteRoot, "app/rehearsal-dslvr-publish-data.ts"),
  `// Generated from the tested reduced DSLVR token package for Testnet rehearsal.\nexport const rehearsalDslvrPublishData = ${JSON.stringify({ modules, dependencies })} as const;\n`,
);
